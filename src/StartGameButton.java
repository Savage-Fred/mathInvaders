    ...
    public void act() 
    {
       ...
       if (wasClicked && gameType  == 'r') {
          if (difficulty == 'a') {
              ...
              Greenfoot.setWorld(new SubtractionWorld());
          }
          else if (difficulty == 'm') {
              // statrt multiplication gametype.
              Greenfoot.setWorld(new MultiplicationWorld());
          }
          else if (difficulty == 'd') {
              // start division gametype.
              Greenfoot.setWorld(new DivisionWorld());
          }
       } 
    }
    
    //------ Setters
    public void setStartDifficulty(char d) { difficulty = d; }
    public void setGameType(char t) {gameType = t;}
    //------ END METHODS
}
